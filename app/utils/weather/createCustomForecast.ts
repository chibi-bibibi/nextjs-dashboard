...
export function createCustomForecast(data: any): Forecast {
  ...
  const today_min = Data[0].temperature.min.celsius? Data[0].temperature.min.celsius:'--'
  const today_max = Data[0].temperature.max.celsius? Data[0].temperature.max.celsius:'--'
  const tomorrow_min = Data[1].temperature.min.celsius? Data[1].temperature.min.celsius:'--'
  const tomorrow_max = Data[1].temperature.max.celsius? Data[1].temperature.max.celsius:'--'
  const future_min = Data[2].temperature.min.celsius? Data[2].temperature.min.celsius:'--'
  const future_max = Data[2].temperature.max.celsius? Data[2].temperature.max.celsius:'--'
